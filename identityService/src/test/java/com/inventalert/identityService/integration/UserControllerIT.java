...
class UserControllerIT {
    ...
    void createUser_success_returns201() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                        ...
                        .content(objectMapper.writeValueAsString(
                                new CreateUserRequest("Staff Member", "staff@acme.com", "password123", Role.MANAGER, null))))
    ...
    void createUser_duplicateEmail_returns409() throws Exception {
        ...
        CreateUserRequest req = new CreateUserRequest("Dup User", "dup@beta.com", "password123", Role.MANAGER, null);
    ...
    void createUser_noToken_returns401() throws Exception {
        mockMvc.perform(post("/api/users")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                new CreateUserRequest("Test User", "x@test.com", "password123", Role.MANAGER, null))))
    ...
    void createUser_managerToken_returns403() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                new CreateUserRequest("Manager", "mgr@delta.com", "password123", Role.MANAGER, null))))
                .andExpect(status().isCreated());
        ...
        mockMvc.perform(post("/api/users")
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                new CreateUserRequest("New User", "new@delta.com", "password123", Role.MANAGER, null))))
    ...
    void listUsers_returns200WithCorrectCount() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                new CreateUserRequest("User One", "u1@epsilon.com", "password123", Role.MANAGER, null))))
                .andExpect(status().isCreated());
        ...
        mockMvc.perform(post("/api/users")
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                new CreateUserRequest("User Two", "u2@epsilon.com", "password123", Role.PROCUREMENT_OFFICER, null))))
                .andExpect(status().isCreated());
